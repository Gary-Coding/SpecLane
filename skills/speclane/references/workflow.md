...
- AI 禁止直接写 `.speclane/current-session.json`、`.speclane/sessions/**/status.json`、`plan.json`、`review.json`、`verify.json`、`notification.json` 和 output 下的标准 Markdown 报告；这些标准产物只能由脚本生成
